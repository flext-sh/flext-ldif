...
<!-- TOC START -->
- [FLEXT-LDIF API Reference](#flext-ldif-api-reference)
  ...
  - [Core API Classes](#core-api-classes)
    - [ldif](#ldif)
      - [Core Operations](#core-operations)
        - [parse\_file(file\_path)](#parse_filefile_path)
        - [parse\_string(content)](#parse_stringcontent)
        - [validate\_entries(entries)](#validate_entriesentries)
        - [write\_file(entries, file\_path)](#write_fileentries-file_path)
        - [write(entries)](#writeentries)
      - [Filtering Operations](#filtering-operations)
        - [filter\_persons(entries)](#filter_personsentries)
        - [filter\_groups(entries)](#filter_groupsentries)
        - [filter\_by\_objectclass(entries, object\_class)](#filter_by_objectclassentries-object_class)
      - [Analytics Operations](#analytics-operations)
        - [get\_entry\_statistics(entries)](#get_entry_statisticsentries)
        - [analyze\_entries(entries)](#analyze_entriesentries)
  ...
  - [⚠️ Library-Only Usage](#️-library-only-usage)
