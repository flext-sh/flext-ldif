...
- [✨ Key Features](#-key-features)
  - [RFC Compliant & Production Ready](#rfc-compliant-production-ready)
  - [Universal Server Support](#universal-server-support)
  - [Enterprise Features](#enterprise-features)
- [📚 Documentation](#-documentation)
- [🏗️ Architecture](#-architecture)
- [💡 Usage Examples](#-usage-examples)
  - [Parse LDIF with Auto-Detection](#parse-ldif-with-auto-detection)
  - [Server-to-Server Migration](#server-to-server-migration)
  - [Filter and Categorize Entries](#filter-and-categorize-entries)
  - [Relaxed Mode for Broken LDIF](#relaxed-mode-for-broken-ldif)
  - [Build and Write Entries](#build-and-write-entries)
- [🔧 Advanced Usage](#-advanced-usage)
  - [Direct flext-core Integration](#direct-flext-core-integration)
  - [Custom Quirks](#custom-quirks)
  - [Performance Tracking](#performance-tracking)
- [🎯 Use Cases](#-use-cases)
  - [Enterprise Directory Migration](#enterprise-directory-migration)
...
- [📞 Support](#-support)
- [Features](#features)
  - [RFC-Compliant Design](#rfc-compliant-design)
  - [Conversion Matrix](#conversion-matrix)
  - [**DN Case Registry**](#dn-case-registry)
  - [**RFC 2849 Compliance (LDIF Format)**](#rfc-2849-compliance-ldif-format)
  - [**RFC 4512 Compliance (Schema)**](#rfc-4512-compliance-schema)
  - [**Server-Specific Quirks (Extensible)**](#server-specific-quirks-extensible)
  - [**Multi-Encoding Support**](#multi-encoding-support)
...
- [🚀 Quick Start](#-quick-start)
  - [**Installation**](#installation)
  - [**Basic Usage (Library-Only API)**](#basic-usage-library-only-api)
- [📚 Advanced Usage Examples](#-advanced-usage-examples)
  - [**Generic Schema Parsing with Quirks (MANDATORY)**](#generic-schema-parsing-with-quirks-mandatory)
  - [**Categorized Entry Migration with Structured Output**](#categorized-entry-migration-with-structured-output)
  - [**Batch and Parallel Processing**](#batch-and-parallel-processing)
  - [**RFC 2849 Compliant Parsing**](#rfc-2849-compliant-parsing)
  - [**Server Detection and Adaptation**](#server-detection-and-adaptation)
  - [**Change Records Processing**](#change-records-processing)
  - [**File Processing with Encoding Detection**](#file-processing-with-encoding-detection)
...
- [📊 Status and Metrics](#-status-and-metrics)
  - [**Current Capabilities (v0.9.0)**](#current-capabilities-v090)
  - [**Known Limitations**](#known-limitations)
  - [**Ecosystem Integration**](#ecosystem-integration)
- [🗺️ Roadmap](#-roadmap)
  - [**Current Version (v0.9.0)**](#current-version-v090)
