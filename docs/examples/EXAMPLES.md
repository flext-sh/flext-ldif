    ...
    def process_directory(self, input_dir: str, output_dir: str) -> dict:
        ...
        for ldif_file in ldif_files:
            ...
            try:
                ...
                error_msg: str = f"Failed to process {ldif_file.name}: {e}"
...
These examples demonstrate the full capabilities of FLEXT-LDIF within the FLEXT ecosystem, from basic usage to processing patterns.
