...
| 5 | medium | low | `non-literal-import` | `src/flext_ldif/services/server.py` | 193 | |
...
Dados brutos: `~/semgrep-violations/by-repo/flext-sh__flext-ldif.json`
