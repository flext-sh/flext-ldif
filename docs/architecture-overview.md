...
System_Ext(flext_projects, "FLEXT Projects", "client-a-oud-mig, flext-api, flext-ldap, etc.")
...
Container_Boundary(flext_ecosystem, "FLEXT Ecosystem") {
    ...
    Container(client-a_oud_mig, "client-a-oud-mig", "Python", "Oracle directory migration project")
...
Rel(client-a_oud_mig, flext_ldif_lib, "Uses", "LDIF processing for Oracle migrations")
