...
- [Troubleshooting](#troubleshooting)
  ...
  - [Attribute Errors on ldif](#attribute-errors-on-flextldif)
...
- ✅ **d applied** - Automatic logging and performance tracking
- ✅ **s inheritance** - Services inherit from base class
...
```python
from flext_ldif import RfcLdifParser
from flext_ldif import RfcLdifWriter
...
```python
from flext_ldif import FlextLdifRfcLdifParser
from flext_ldif import FlextLdifRfcLdifWriter
...
from flext_ldif import FlextLdifStatistics
from flext_ldif import FlextLdifDn
from flext_ldif import FlextLdifFileWriter
```
...
```python
from flext_ldif import FlextLdifAclParser
from flext_ldif import FlextLdifAcl
...
from flext_ldif import FlextLdifCategorizedPipeline
```
...
from flext_ldif import FlextLdifServersManager
from flext_ldif import QuirksConversionMatrix
...
```python
settings = ldif.settings  # ❌ Property removed
```
...
result = ldif.build(
    "person", cn="John", sn="Doe", base_dn="dc=example"
)  # ✅ Same usage
...
### Attribute Errors on ldif

**Error**: `AttributeError: 'ldif' t.RecursiveContainer has no attribute 'processors'`
...
**Error**: `AttributeError: 'ldif' t.RecursiveContainer has no attribute 'get_entry_dn'`
