...
- [What It Sorts (sort_target parameter)](#what-it-sorts-sort_target-parameter)
- [How It Sorts Entries (sort_by parameter)](#how-it-sorts-entries-sort_by-parameter)
...
- [Attribute & ACL Sorting Options](#attribute-acl-sorting-options)
  - [When sort_target="attributes"](#when-sort_targetattributes)
  - [When sort_target="acl"](#when-sort_targetacl)
