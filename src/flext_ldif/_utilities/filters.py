...
class FlextLdifUtilitiesFilters[T]:
    ...
    def __invert__(self) -> FlextLdifUtilitiesFilters.NotFilter[T]:
        """NOT negation: ~filter."""
    ...
    class Filter:
        ...
        def by_objectclass(
            *classes: str,
            mode: Literal["any", "all"] = "any",
            case_insensitive: bool = True,
        ) -> FlextLdifUtilitiesFilters.ByObjectClassFilter:
            """Create an objectClass filter."""
            return FlextLdifUtilitiesFilters.ByObjectClassFilter(
                *classes,
                mode=mode,
                case_insensitive=case_insensitive,
            )
        ...
        ) -> FlextLdifUtilitiesFilters.CustomFilter:
            """Create a custom filter from a predicate function."""
            return FlextLdifUtilitiesFilters.CustomFilter(predicate)
...
AndFilter = FlextLdifUtilitiesFilters.AndFilter
OrFilter = FlextLdifUtilitiesFilters.OrFilter
NotFilter = FlextLdifUtilitiesFilters.NotFilter
ByDnFilter = FlextLdifUtilitiesFilters.ByDnFilter
ByDnUnderBaseFilter = FlextLdifUtilitiesFilters.ByDnUnderBaseFilter
ByObjectClassFilter = FlextLdifUtilitiesFilters.ByObjectClassFilter
ByAttrsFilter = FlextLdifUtilitiesFilters.ByAttrsFilter
ByAttrValueFilter = FlextLdifUtilitiesFilters.ByAttrValueFilter
ExcludeAttrsFilter = FlextLdifUtilitiesFilters.ExcludeAttrsFilter
IsSchemaFlextLdifUtilitiesFilters = (
    FlextLdifUtilitiesFilters.IsSchemaFlextLdifUtilitiesFilters
)
CustomFilter = FlextLdifUtilitiesFilters.CustomFilter
Filter = FlextLdifUtilitiesFilters.Filter
