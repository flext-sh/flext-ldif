...
class FlextLdifUtilitiesBuilders:
    """Fluent builders for LDIF configuration objects."""
    ...
    class ProcessConfigBuilder:
        ...
        def __init__(self) -> None:
            ...
            self._attr_config: FlextLdifModels.Ldif.AttrNormalizationConfig | None = (
                None
            )
        ...
        def build(self) -> FlextLdifModels.Ldif.ProcessConfig:
            ...
            return FlextLdifModels.Ldif.ProcessConfig(
                ...
                dn_config=self._dn_config
                or FlextLdifModels.Ldif.DnNormalizationConfig(),
                attr_config=self._attr_config
                or FlextLdifModels.Ldif.AttrNormalizationConfig(),
                acl_config=self._acl_config
                or FlextLdifModels.Ldif.AclConversionConfig(),
        ...
        def normalize_attrs(
            ...
            *,
            ...
            self._attr_config = (
                FlextLdifModels.Ldif.AttrNormalizationConfig.model_validate(
                    config_kwargs,
                )
            )
            return self
    ...
    class WriteConfigBuilder:
        ...
        def format(self, fmt: c.Ldif.OutputFormat) -> Self:
            """Set output format."""
            self._format = fmt
            return self
