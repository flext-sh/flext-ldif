...
class FlextLdifDn(FlextLdifServiceBase[str]):
    ...
    @classmethod
    def parse_components(cls, dn: str) -> r[MutableSequence[tuple[str, str]]]:
        """Parse DN into RFC 4514 compliant components."""
        return cls.Parser.parse_components(dn)

    @classmethod
    def parse_rdn(cls, rdn: str) -> r[MutableSequence[tuple[str, str]]]:
    ...
    def _dispatch_operation(self) -> r[str]:
        ...
        handlers: MutableMapping[str, Callable[[], r[str]]] = {
    ...
    class Parser:
        ...
        @staticmethod
        def parse_components(dn: str) -> r[MutableSequence[tuple[str, str]]]:
            """Parse DN into RFC 4514 compliant components."""
