    ...
    class CaseRegistry(FlextModels.Value):
        ...
        def _normalize_dn(self, dn: str) -> str:
            ...
            Examples:
                ...
                >>> registry._normalize_dn("cn = admin , dc = com")
                'cn=admin,dc=com'
        ...
        def has_dn(self, dn: str) -> bool:
            ...
            Examples:
                >>> registry = FlextLdifDnService.CaseRegistry()
                >>> registry.register_dn("CN=Admin,DC=Com")
                >>> registry.has_dn("cn=admin,dc=com")
                True
        ...
        def get_case_variants(self, dn: str) -> set[str]:
            ...
            Examples:
                ...
                >>> registry.register_dn("cn=admin,dc=com")
                >>> registry.register_dn("cn=ADMIN,dc=COM")
                >>> registry.get_case_variants("cn=admin,dc=com")
        ...
        def normalize_dn_references(
            ...
            Examples:
                ...
                >>> normalized = result.unwrap()
                >>> normalized
                {FlextLdifConstants.DictKeys.DN: 'cn=admin,dc=com', FlextLdifConstants.DnValuedAttributes.MEMBER: ['cn=admin,dc=com']}
