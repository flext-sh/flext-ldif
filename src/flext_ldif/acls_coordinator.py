...
class FlextLdifAcls(FlextService[dict[str, object]]):
    ...
    class Parser:
        ...
        def parse_ad(self, acl_string: str) -> FlextResult[FlextLdifModels.UnifiedAcl]:
            """Parse Active Directory ACL format."""
            return self._parser.parse_acl(
                acl_string, constants.SERVER_TYPE_ACTIVE_DIRECTORY
            )
        ...
        def extract_from_entries(
            ...
            for entry in entries:
                acl_result: FlextResult[list[FlextLdifModels.UnifiedAcl]] = (
                    self._service.extract_acls_from_entry(entry, server_type)
                )
    ...
    class Builder:
        ...
        def build_REDACTED_LDAP_BIND_PASSWORD_permission(
            ...
            return FlextLdifModels.UnifiedAcl.create(
                ...
                permissions=perms_result,
                server_type="generic",
                raw_acl=f"to {target_dn} by {subject_dn} REDACTED_LDAP_BIND_PASSWORD",
            )
    ...
    class Converter:
        ...
        def _get_operations_list(
            self, perms: FlextLdifModels.AclPermissions
        ) -> list[str]:
        ...
        def to_openldap(self, acl: FlextLdifModels.UnifiedAcl) -> FlextResult[str]:
        ...
        def to_389ds(self, acl: FlextLdifModels.UnifiedAcl) -> FlextResult[str]:
        ...
        def to_oracle(self, acl: FlextLdifModels.UnifiedAcl) -> FlextResult[str]:
        ...
        def to_ad(self, acl: FlextLdifModels.UnifiedAcl) -> FlextResult[str]:
