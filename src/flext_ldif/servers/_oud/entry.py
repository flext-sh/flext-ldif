...
class FlextLdifServersOudEntry(FlextLdifServersRfc.Entry):
    ...
    **Entry with Complex ACI** (multi-line)::
    ...
    def _normalize_acl_values(
        acl_values_raw: t.MetadataValue,
    ...
    def update_metadata_with_commented_acls(
        ...
        if commented_acl_values:
            ...
            converted_attrs_typed: t.MetadataValue = list(converted_attrs_list)
        ...
        if commented_attrs:
            commented_attrs_typed: t.MetadataValue = list(commented_attrs)
    ...
    def _extract_acl_metadata_from_dict(
        self,
        acl_extensions: Mapping[str, t.MetadataValue],
        acl_metadata_extensions: dict[str, t.MetadataValue],
    ) -> None:
    ...
    def _find_aci_in_dict(
        self, attrs: Mapping[str, object] | None
    ) -> list[str] | str | None:
    ...
    @override
    def _hook_pre_write_entry(self, entry: m.Ldif.Entry) -> FlextResult[m.Ldif.Entry]:
    ...
    def _merge_acl_metadata_to_entry(
        self,
        entry: m.Ldif.Entry,
        acl_metadata_extensions: Mapping[str, t.MetadataValue],
    ) -> m.Ldif.Entry:
    ...
    def _process_single_aci_value(
        ...
        has_macros = bool(re.search("\\(\\$dn\\)|\\[\\$dn\\]|\\(\\$attr\\.", aci_value))
        ...
        if parse_result.is_success:
            ...
            if parsed_acl.metadata and parsed_acl.metadata.extensions:
                ...
                if core_u.is_type(
                    ...
                    acl_extensions_dict: dict[str, t.MetadataValue] = {
                        str(
                            k
                        ): FlextLdifModelsMetadata.DynamicMetadata.coerce_metadata_value(
                            v
    ...
    @override
    def _write_entry(self, entry_data: m.Ldif.Entry) -> FlextResult[str]:
    ...
    def _write_entry_as_comment(self, entry_data: m.Ldif.Entry) -> FlextResult[str]:
