...
class FlextLdifAPI(FlextService[FlextLdifTypes.HealthStatusDict]):
    ...
    def _log_write_file_success(self, *, success: bool) -> bool:
        ...
        """
        self._logger.info("Successfully wrote LDIF file: %s", success)
        return success
    ...
    def _log_analysis_success(
        self,
        stats: FlextLdifTypes.LdifStatistics,
    ...
    def filter_persons(
        ...
        try:
            ...
            return FlextResult[list[FlextLdifModels.Entry]].fail(
                ...
                error_code="PERSON_FILTER_ERROR",
            )
