...
_LAZY_IMPORTS = merge_lazy_imports(
    ...
    exclude_names=(
        # Private server implementation modules stay behind their canonical
        # owners (flext_ldif.servers._*); they must never resolve from the
        # root package (frozen public API contract).
