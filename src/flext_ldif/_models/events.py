...
class FlextLdifModelsEvents:
    ...
    class DnEventConfig(m.StrictModel):
        ...
        output_dn: Annotated[
            str | None, u.Field(description="Resulting DN after operation")
        ] = None
        ...
        parse_components: Annotated[
            ...
            u.Field(description="Parsed RDN components as (attribute, value) pairs"),
        ] = None
    ...
    class ConversionEventConfig(m.StrictModel):
        ...
        items_converted: Annotated[
            int, u.Field(description="Items successfully converted")
        ] = 0
        items_failed: Annotated[
            int, u.Field(description="Items that failed conversion")
        ] = 0
    ...
    class DnEvent(m.DomainEvent):
        ...
        dn_duration_ms: Annotated[
            float, u.Field(description="DN operation duration in milliseconds")
        ] = 0.0
        validation_result: Annotated[
            bool | None, u.Field(description="Whether the DN passed validation")
        ] = None
        has_output: Annotated[
            bool, u.Field(description="Whether the operation produced output")
        ] = False
    ...
    class ConversionEvent(m.DomainEvent):
        ...
        conversion_success_rate: Annotated[
            float, u.Field(description="Percentage of items successfully converted")
        ] = 0.0
        throughput_items_per_sec: Annotated[
            float, u.Field(description="Conversion throughput in items per second")
        ] = 0.0
