...
class FlextLdifModelsDomainAcl:
    ...
    class OidAclSubject(m.FrozenModel):
        ...
        permissions: Annotated[
            t.StrSequence,
            u.Field(
                description="Raw OID permission tokens for this by-clause",
            ),
        ] = ()
    ...
    class OidAclRule(m.FrozenModel):
        ...
        acl_type: Annotated[
            str,
            u.Field(description="orclaci | orclentrylevelaci"),
        ]
        ...
        subjects: Annotated[
            tuple[FlextLdifModelsDomainAcl.OidAclSubject, ...],
            u.Field(
                description="Parsed by-clause subjects",
            ),
        ] = ()
        raw_line: Annotated[
            str,
    ...
    class AciAllow(m.FrozenModel):
        ...
        permissions: Annotated[
            t.StrSequence,
            u.Field(
                description="OUD permission tokens in canonical order",
            ),
        ] = ()
    ...
    class AciRule(m.FrozenModel):
        ...
        allows: Annotated[
            tuple[FlextLdifModelsDomainAcl.AciAllow, ...],
