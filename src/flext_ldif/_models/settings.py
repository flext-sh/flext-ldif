...
class FlextLdifModelsSettings:
    ...
    @staticmethod
    def _rdn_pairs_factory() -> Sequence[tuple[str, str]]:
        return []
    ...
    class WriteConfig(FlextModels.Value):
        ...
        base64_attrs: Annotated[Sequence[str] | None, Field()] = None
        sort_by: Annotated[str | None, Field()] = None
        attr_order: Annotated[Sequence[str] | None, Field()] = None
    ...
    class CategoryRules(FlextModels.Rules):
        ...
        Replaces Mapping[str, t.NormalizedValue] with type-safe Pydantic model.
        """
    ...
    class MigrateOptions(FlextModels.Value):
        ...
        output_files: Annotated[
            Mapping[c.Ldif.Categories, str] | None,
            Field(
    ...
    class EncodingRules(FlextModels.Value):
        ...
        allowed_encodings: Annotated[Sequence[str], Field()] = Field(
    ...
    class LdifContentParseConfig(FlextModels.Value):
        ...
        parse_entry_hook: Annotated[
            Callable[
                [str, Mapping[str, Sequence[str]]], r[FlextLdifModelsDomains.Entry]
            ],
        ...
        transform_attrs_hook: Annotated[
            Callable[
                ...
                tuple[str, Mapping[str, Sequence[str]]],
            ]
            | None,
            Field(
                default=None,
        ...
        ldif_parser: Annotated[
            Callable[[str], Sequence[tuple[str, Mapping[str, Sequence[str]]]]] | None,
    ...
    class EntryWriteConfig(FlextModels.Value):
        ...
        write_attributes_hook: Annotated[
            Callable[[FlextLdifModelsDomains.Entry, Sequence[str]], None],
            Field(..., description="Core attributes writing"),
        ]
        write_comments_hook: Annotated[
            Callable[[FlextLdifModelsDomains.Entry, Sequence[str]], None] | None,
