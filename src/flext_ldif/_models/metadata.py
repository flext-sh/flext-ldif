...
class _DynamicMetadata(m.DynamicModel):
    ...
    server_specific_violations: MutableSequence[t.Ldif.MetadataValue] | None = Field(
        default=None, description="Server-specific validation violations"
    )
...
class _EntryMetadata(m.FrozenDynamicModel):
