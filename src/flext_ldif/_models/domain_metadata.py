...
from flext_ldif._models.domain_attributes import _AttributeTransformation
...
class _ValidationMetadata(m.FrozenModel):
...
class _WriteOptions(m.FrozenModel):
...
class _FormatDetails(m.FrozenModel):
...
class _SchemaFormatDetails(m.FrozenModel):
...
class _QuirkMetadata(m.DynamicModel):
    ...
    attribute_transformations: MutableMapping[str, _AttributeTransformation] = Field(
    ...
    validation_results: _ValidationMetadata | None = Field(
        default=None,
    ...
    write_options: _WriteOptions | None = Field(
        default=None,
    ...
    original_format_details: _FormatDetails | None = Field(
        default=None,
        description="Original formatting details for round-trip preservation (DN line, syntax, encoding, spacing)",
    )
    schema_format_details: _SchemaFormatDetails | None = Field(
        default=None,
...
class FlextLdifModelsDomainMetadata:
    ...
    FormatDetails = _FormatDetails
    SchemaFormatDetails = _SchemaFormatDetails
    QuirkMetadata = _QuirkMetadata


_all__ = ["FlextLdifModelsDomainMetadata"]
