<!-- Generated from docs/guides/troubleshooting.md for flext-ldif. -->

<!-- Source of truth: workspace docs/guides/. -->

# flext-ldif - FLEXT Troubleshooting Guide

> Project profile: `flext-ldif`

<!-- TOC START -->
- [flext-ldif - FLEXT Troubleshooting Guide](#flext-ldif---flext-troubleshooting-guide)
...
try:
    ...
    u.Cli.print(f"Configuration error: {error}")
```
