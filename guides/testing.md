<!-- Generated from docs/guides/testing.md for flext-ldif. -->

<!-- Source of truth: workspace docs/guides/. -->

# flext-ldif - FLEXT Testing Guide
...
def load_json_fixture(fixture_name: str) -> dict[str, t.JsonValue]:
