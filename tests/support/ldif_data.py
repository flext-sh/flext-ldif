...
class LdifTestData:
    ...
    @staticmethod
    def basic_entries() -> m.Ldif.Tests.LdifSample:
        ...
        return m.Ldif.Tests.LdifSample(
            content=content,
    ...
    @staticmethod
    def with_binary_data() -> m.Ldif.Tests.LdifSample:
    ...
    @staticmethod
    def with_changes() -> m.Ldif.Tests.LdifSample:
    ...
    @staticmethod
    def multi_valued_attributes() -> m.Ldif.Tests.LdifSample:
    ...
    @staticmethod
    def long_lines() -> m.Ldif.Tests.LdifSample:
    ...
    @staticmethod
    def special_characters() -> m.Ldif.Tests.LdifSample:
    ...
    @staticmethod
    def empty_and_null_values() -> m.Ldif.Tests.LdifSample:
    ...
    @staticmethod
    def invalid_data() -> m.Ldif.Tests.LdifSample:
    ...
    @staticmethod
    def large_dataset(num_entries: int = 100) -> m.Ldif.Tests.LdifSample:
    ...
    @classmethod
    def all_samples(cls) -> Mapping[str, m.Ldif.Tests.LdifSample]:
