...
_LAZY_IMPORTS = build_lazy_import_map({
    ...
    ".test_minimal_differences_metadata": ("TestsFlextLdifMinimalDifferencesMetadata",),
    ...
    ".test_rfc_docker_real_integration": ("TestsFlextLdifRfcDockerRealIntegration",),
    ".test_simple_ldap": ("TestsFlextLdifSimpleLdap",),
    ".test_systematic_fixture_coverage": ("TestsFlextLdifSystematicFixtureCoverage",),
