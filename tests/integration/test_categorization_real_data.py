...
Real-world scenarios (like CTBC) are tested in algar-oud-mig project.
...
class TestCategorizationRealData:
    ...
    def test_base_dn_substring_matching_edge_cases(self, tmp_path: Path) -> None:
        ...
        about specific projects like algar-oud-mig or CTBC.
        """
        base_dn = "dc=example"
    ...
    def test_acl_filtering_substring_matching_edge_cases(self, tmp_path: Path) -> None:
        ...
        # Filter ACLs by base DN (simulating algar-oud-mig logic)
