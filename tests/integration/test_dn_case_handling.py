...
class TestsFlextLdifDnCaseHandling:
    ...
    def test_later_variants_return_the_original_canonical(
        self, registry: m.Ldif.DnRegistry, variant: str
    ) -> None:
    ...
    def test_resolution_is_case_insensitive(
        self, registry: m.Ldif.DnRegistry, lookup: str
    ) -> None:
    ...
    def test_empty_registry_is_consistent(self, registry: m.Ldif.DnRegistry) -> None:
    ...
    def test_clear_resets_consistency_state(self, registry: m.Ldif.DnRegistry) -> None:
