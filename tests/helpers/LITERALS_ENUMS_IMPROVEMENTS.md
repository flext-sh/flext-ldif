...
1. **Compatibilidade Retroativa**: Parâmetros aceitam `Literal | str`
1. **Não Duplicação**: Constants de teste não duplicam src/constants.py
1. **Type Safety**: Uso de `Final` e `TypeAlias` para imutabilidade
