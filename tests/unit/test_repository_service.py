...
class TestFlextLdifRepositoryService:
    ...
    def test_find_by_dn_empty_dn(self):
    ...
    def test_find_by_dn_whitespace_only_dn(self):
    ...
    def test_find_by_dn_not_found(self):
    ...
    def test_find_by_dn_found_exact_match(self):
    ...
    def test_find_by_dn_case_insensitive(self):
    ...
    def test_find_by_dn_multiple_entries(self):
    ...
    def test_filter_by_objectclass_empty_objectclass(self):
    ...
    def test_filter_by_objectclass_whitespace_only(self):
    ...
    def test_filter_by_objectclass_no_matches(self):
    ...
    def test_filter_by_objectclass_with_matches(self):
    ...
    def test_filter_by_objectclass_multiple_matches(self):
    ...
    def test_filter_by_attribute_empty_attribute(self):
    ...
    def test_filter_by_attribute_whitespace_attribute(self):
    ...
    def test_filter_by_attribute_no_matches(self):
    ...
    def test_filter_by_attribute_with_matches(self):
    ...
    def test_filter_by_attribute_no_attribute_values(self):
    ...
    def test_get_statistics_with_person_entries(self):
    ...
    def test_get_statistics_with_group_entries(self):
    ...
    def test_get_statistics_with_other_entries(self):
    ...
    def test_get_statistics_mixed_entries(self):
