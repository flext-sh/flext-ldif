...
EXCLUSION_METADATA_TESTS: Final[list[ExclusionMetadataTestCase]] = [
    ExclusionMetadataTestCase("none_metadata", object] to dict[str, objectclass: str | None, objectclass=objectclass or "", objectclass=str(filter_kwargs.get("objectclass", ou=admin, ou=users, required_attributes=filter_kwargs.get("required_attributes"), rules, s, should_raise=True, should_raise=True), str | list[str]], str | list[str]] = {
