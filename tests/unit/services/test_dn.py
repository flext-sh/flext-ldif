"""Tests for FlextLdif Distinguished Name (DN) service functionality.
...
class TestsFlextLdifDnService(s):
    ...
    ESCAPING_DATA: ClassVar[tuple[tuple[str, str], ...]] = (
        ...
        (" admin", "\\20admin"),  # Starts with hex space
        ("admin ", "admin\\20"),  # Ends with hex space
        ("", ""),
    )
    ...
    def test_registry_stats(self) -> None:
        ...
        variant_dn = "cn=admin,dc=example,dc=com"
