...
class TestsFlextLdifAnalysisService:
    ...
    @staticmethod
    def _make_entry(dn: str | None, attrs: dict[str, list[str]] | None) -> p.Ldif.Entry:
    ...
    def test_valid_objectclass_names_pass_validation(
        self, oc_name: str, api: p.Ldif.Client
    ) -> None:
    ...
    def test_validate_entries_none_dn_reports_invalid(self, api: p.Ldif.Client) -> None:
