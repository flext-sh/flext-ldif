...
class TestGroupMembership:
    ...
    def test_check_group_email_requirement_no_requirement(
        ...
        """Test checking email requirement for non-admin group."""
        group = create_entry(
    ...
    def test_check_group_email_requirement_admin_with_email(
        self,
        entry_manipulation_service: EntryManipulationServices,
        simple_user_entry: FlextLdifModels.Entry,
        group_entry: FlextLdifModels.Entry,
    ) -> None:
        """Test checking email requirement for admin group with email."""
        result = entry_manipulation_service.check_group_email_requirement(
            simple_user_entry,
            group_entry,
        )
    ...
    def test_check_group_email_requirement_admin_without_email(
        self,
        entry_manipulation_service: EntryManipulationServices,
        group_entry: FlextLdifModels.Entry,
    ) -> None:
        """Test checking email requirement for admin group without email."""
        user = create_entry(
