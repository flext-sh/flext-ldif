...
class FilterTestData:
    ...
    DN_PATTERN_ADMINS: Final[str] = "*,ou=REDACTED_LDAP_BIND_PASSWORDs,*"
    ...
    DN_USER_ADMIN: Final[str] = "cn=REDACTED_LDAP_BIND_PASSWORD,ou=REDACTED_LDAP_BIND_PASSWORDs,dc=example,dc=com"
    ...
    def create_user_entries(cls) -> list[FlextLdifModels.Entry]:
        ...
        return [
            ...
            cls.create_entry(
                ...
                {
                    FilterTestData.ATTR_CN: ["REDACTED_LDAP_BIND_PASSWORD"],
                    FilterTestData.ATTR_OBJECTCLASS: [FilterTestData.OC_PERSON],
                },
            ),
        ]
...
class TestFilterService:
    ...
    class TestExclusionHelpers:
        ...
        def test_is_entry_excluded(
            ...
            # Find excluded entry
            excluded = [
                e for e in filtered if ",ou=REDACTED_LDAP_BIND_PASSWORDs," in (e.dn.value if e.dn else "")
            ]
            if excluded:
