...
def user_entries() -> list[m.Ldif.Entry]:
    ...
    return [
        create_entry(
            ...
            {
                Filters.ATTR_CN: [Filters.Values.USER1],
                Filters.ATTR_MAIL: ["user1@example.com"],
        ...
        create_entry(
            ...
            {
                Filters.ATTR_CN: [Filters.Values.USER2],
                Filters.ATTR_MAIL: ["user2@example.com"],
                Filters.ATTR_OBJECTCLASS: [Filters.OC_PERSON],
            },
        ),
        create_entry(
            ...
            {
                Filters.ATTR_CN: [Filters.Values.ADMIN],
                Filters.ATTR_OBJECTCLASS: [Filters.OC_PERSON],
            },
        ),
    ]
...
def mixed_entries() -> list[m.Ldif.Entry]:
    ...
    return [
        create_entry(
            f"cn=users,ou=groups,{Filters.DNs.EXAMPLE}",
            {
    ...
    return [
        create_entry(
            Filters.DNs.SCHEMA,
            {
                ...
                "attributeTypes": [
                    f"( {OIDs.CN} NAME '{c.Rfc.ATTR_NAME_CN}' EQUALITY caseIgnoreMatch )",
                ],
            },
        ),
        create_entry(
            Filters.DNs.SCHEMA,
            {
                Filters.ATTR_CN: ["schema"],
                "objectClasses": [
                    f"( {OIDs.PERSON} NAME '{c.Rfc.OC_NAME_PERSON}' SUP top )",
                ],
            },
        ),
    ]
    ...
    def test_transformation_scenarios(
        ...
        if scenario == TransformationScenario.REMOVE_ATTRIBUTES:
            ...
            entry = create_entry(
                ...
                {
                    Filters.ATTR_CN: ["test"],
                    Filters.ATTR_OBJECTCLASS: [c.Rfc.OC_NAME_TOP, Filters.OC_PERSON],
                },
            )
            TestDeduplicationHelpers.remove_objectclasses_and_validate(
                entry,
                [Filters.OC_PERSON],
                must_still_have=[c.Rfc.OC_NAME_TOP],
            )
