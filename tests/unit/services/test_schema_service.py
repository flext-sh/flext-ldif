"""Comprehensive unit tests for FlextLdifSchema service.

Tests all schema service methods with REAL implementations.
...
class TestSchemaServiceExecute:
    ...
    def test_execute_returns_status(
        ...
        assert isinstance(status, FlextLdifModels.SchemaServiceStatus)
