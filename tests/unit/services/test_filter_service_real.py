...
OBJECTCLASS_TESTS: Final[list[ObjectClassTestCase]] = [
    ObjectClassTestCase("inetorgperson", Filters.OC_INET_ORG_PERSON, Filters.ATTR_MAIL),
    ...
    ObjectClassTestCase("person", Filters.OC_PERSON, Filters.ATTR_SN),
]
...
BUILDER_TESTS: Final[list[BuilderTestCase]] = [
    ...
    BuilderTestCase(
        "objectclass_attrs",
        "objectclass_attrs",
        objectclass=Filters.OC_INET_ORG_PERSON,
