...
class TestsFlextLdifDetectorService:
    ...
    def test_detect_fails_when_no_inputs_given(self, api: p.Ldif.Client) -> None:
    ...
    def test_detect_oid_snippet_reports_acl_patterns(self, api: p.Ldif.Client) -> None:
    ...
    def test_detect_recognises_server_types_from_snippets(
        self, scenario: str, snippet: str, expected_type: str, api: p.Ldif.Client
    ) -> None:
    ...
    def test_detect_respects_max_lines_limit(self, api: p.Ldif.Client) -> None:
    ...
    def test_detect_additional_snippets_return_detection(
        self, scenario: str, snippet: str, api: p.Ldif.Client
    ) -> None:
        result = api.detect_server_type(ldif_content=snippet)
        detection = u.Tests.assert_success(
            result, error_msg=f"detection failed for {scenario}"
    ...
    def test_detect_is_idempotent_for_same_content(self, api: p.Ldif.Client) -> None:
        ...
        tm.that(first.detected_server_type, eq=second.detected_server_type)
