...
class TestsFlextLdifDetectorService:
    ...
    def test_detect_fails_when_no_inputs_given(self, api: p.Ldif.LdifClient) -> None:
        result = api.detect_server_type()
        tm.fail(result, has="must be provided")

    def test_detect_fails_when_file_is_missing(
        self, api: p.Ldif.LdifClient, tmp_path: Path
    ) -> None:
    ...
    def test_detect_respects_max_lines_limit(self, api: p.Ldif.LdifClient) -> None:
