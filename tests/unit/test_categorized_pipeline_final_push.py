...
""")
        ...
        file3.write_text("""dn: cn=REDACTED_LDAP_BIND_PASSWORDs,dc=example,dc=com
...
dn: cn=REDACTED_LDAP_BIND_PASSWORD1,dc=example,dc=com
objectClass: person
objectClass: REDACTED_LDAP_BIND_PASSWORDistrativeRole
cn: REDACTED_LDAP_BIND_PASSWORD1
sn: Admin
""")
