...
class TestFlextLdifAclService:
    ...
    @pytest.fixture
    def acl_service_with_config(self) -> FlextLdifAclService:
        """Create ACL service with custom config."""
        config = FlextLdifConfig()
        return FlextLdifAclService(config=config)

    def test_initialization_default(self, acl_service: FlextLdifAclService) -> None:
    ...
    def test_initialization_with_config(
        self,
        acl_service_with_config: FlextLdifAclService,
    ) -> None:
    ...
    def test_execute_success(self, acl_service: FlextLdifAclService) -> None:
