...
class TestErrorHandling:
    ...
    def test_invalid_data_type(
        ...
        invalid_model = cast(
            "FlextLdifModels.Acl | FlextLdifModels.Entry | FlextLdifModels.SchemaAttribute | FlextLdifModels.SchemaObjectClass",
...
class TestDnCaseRegistryIntegration:
    ...
    def test_validate_oud_conversion(
        ...
        TestDeduplicationHelpers.helper_result_and_assert_fields(
            cast("FlextResult[object]", conversion_matrix.validate_oud_conversion()),
...
class TestAttributeConversionErrorPaths:
    ...
    def test_convert_attribute_missing_parse_method(
        ...
        result = conversion_matrix.convert(
            cast("FlextLdifServersBase", source),
            cast("FlextLdifServersBase", target),
            model,
        )
...
class TestSupportCheckingEdgeCases:
    ...
    def test_get_supported_conversions_minimal(
        ...
        TestDeduplicationHelpers.helper_get_supported_conversions_and_assert(
            conversion_matrix,
            cast("FlextLdifServersBase", MinimalQuirk()),
            expected_support={
                "attribute": False,
                "objectClass": False,
                "acl": False,
    ...
    def test_get_supported_conversions_partial(
        ...
        TestDeduplicationHelpers.helper_get_supported_conversions_and_assert(
            conversion_matrix,
            cast("FlextLdifServersBase", PartialAttributeQuirk()),
            expected_support={
                "attribute": True,
                "objectClass": False,
                "acl": False,
    ...
    def test_get_supported_conversions_acl(
        ...
        TestDeduplicationHelpers.helper_get_supported_conversions_and_assert(
            conversion_matrix,
            cast("FlextLdifServersBase", AclOnlyQuirk()),
            expected_support={
                "attribute": False,
                "objectClass": False,
                "acl": True,
    ...
    def test_get_supported_conversions_entry(
        ...
        TestDeduplicationHelpers.helper_get_supported_conversions_and_assert(
            conversion_matrix,
            cast("FlextLdifServersBase", EntryOnlyQuirk()),
            expected_support={
                "attribute": False,
                "objectClass": False,
                "acl": False,
