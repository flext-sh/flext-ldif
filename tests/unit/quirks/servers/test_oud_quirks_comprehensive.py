...
via client-aOudMigConstants.Schema.BLOCKED_* sets. Quirks return True for all attributes/classes.
...
class TestOudQuirksCanHandleArchitecture:
    ...
    def test_can_handle_attribute_non_oud_returns_true(
        ...
        Filtering (if needed) is handled by migration service via client-aOudMigConstants,
