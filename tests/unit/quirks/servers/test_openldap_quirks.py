...
class TestOpenLDAP2xSchemas:
    ...
    def test_can_handle_attribute_with_olc_prefix(
        ...
        assert quirk._can_handle_attribute(ldif_line) is True
    ...
    def test_can_handle_attribute_without_olc(
        self, quirk: FlextLdifServersOpenldap.Schema
    ) -> None:
    ...
    def test_can_handle_objectclass_with_olc(
        self, quirk: FlextLdifServersOpenldap.Schema
    ) -> None:
        ...
        assert quirk._can_handle_objectclass(ldif_line) is True
    ...
    def test_can_handle_objectclass_without_olc(
        self, quirk: FlextLdifServersOpenldap.Schema
    ) -> None:
...
class TestOpenldapSchemaWriteAttribute:
    ...
    def test_write_attribute_to_rfc(
        ...
        result = openldap_quirk.write(attr_data)
        assert hasattr(result, "is_success")
        if result.is_success:
            attr_str = result.unwrap()
...
class TestOpenldapSchemaWriteObjectClass:
    ...
    def test_write_objectclass_to_rfc(
        ...
        result = openldap_quirk.write(oc_data)
        assert hasattr(result, "is_success")
        if result.is_success:
            oc_str = result.unwrap()
...
class TestOpenldapAclCanHandleAcl:
    ...
    def test_can_handle_non_acl(self, openldap_quirk: FlextLdifServersOpenldap) -> None:
...
class TestOpenldapAclParseAcl:
    ...
    def test_parse_basic_acl(self, openldap_quirk: FlextLdifServersOpenldap) -> None:
    ...
    def test_parse_indexed_acl(self, openldap_quirk: FlextLdifServersOpenldap) -> None:
...
class TestOpenldapAclConvertAcl:
    ...
    def test_write_acl_to_rfc(self, openldap_quirk: FlextLdifServersOpenldap) -> None:
