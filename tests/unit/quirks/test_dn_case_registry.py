...
Tests the FlextLdifDnCaseRegistry class that tracks canonical DN case during
...
class TestDnNormalization:
    ...
    def test_normalize_removes_spaces(self, registry: FlextLdifDnCaseRegistry) -> None:
    ...
    def test_normalize_idempotent(self, registry: FlextLdifDnCaseRegistry) -> None:
...
class TestCanonicalDnRetrieval:
    ...
    def registry(self) -> FlextLdifDnCaseRegistry:
        ...
        reg = FlextLdifDnCaseRegistry()
        reg.register_dn("cn=admin,dc=example,dc=com")
        reg.register_dn("ou=users,dc=example,dc=com")
        return reg

    def test_get_canonical_exact_match(self, registry: FlextLdifDnCaseRegistry) -> None:
    ...
    def test_get_canonical_with_spaces(self, registry: FlextLdifDnCaseRegistry) -> None:
...
class TestDnExistenceCheck:
    ...
    def test_has_dn_exact_match(self, registry: FlextLdifDnCaseRegistry) -> None:
        """Test has_dn with exact match."""
        assert registry.has_dn("cn=admin,dc=com")
        assert registry.has_dn("ou=users,dc=com")

    def test_has_dn_different_case(self, registry: FlextLdifDnCaseRegistry) -> None:
        """Test has_dn is case-insensitive."""
        assert registry.has_dn("CN=Admin,DC=Com")
        assert registry.has_dn("cn=ADMIN,dc=COM")
        assert registry.has_dn("OU=Users,DC=Com")

    def test_has_dn_with_spaces(self, registry: FlextLdifDnCaseRegistry) -> None:
...
class TestDnReferenceNormalization:
    ...
    def test_normalize_single_dn_field(self, registry: FlextLdifDnCaseRegistry) -> None:
    ...
    def test_normalize_list_of_dns(self, registry: FlextLdifDnCaseRegistry) -> None:
...
__all__ = [
    ...
    "TestDnRegistration",
    "TestEdgeCases",
    "TestFlextLdifDnCaseRegistryInitialization",
