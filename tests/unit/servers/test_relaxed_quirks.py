...
class TestsTestFlextLdifRelaxedQuirks:
    ...
    @pytest.mark.parametrize(
        ...
        ids=list(c.Ldif.Tests.RELAXED_ATTRIBUTE_DEFINITIONS.keys()),
    )
    ...
    @pytest.mark.parametrize(
        ("scenario", "definition_data"),
        list(c.Ldif.Tests.RELAXED_OBJECTCLASS_DEFINITIONS.items()),
        ids=list(c.Ldif.Tests.RELAXED_OBJECTCLASS_DEFINITIONS.keys()),
    )
    ...
    @pytest.mark.parametrize(
        ...
        ids=list(c.Ldif.Tests.RELAXED_ACL_DEFINITIONS.keys()),
    )
