    ...
    build_lazy_import_map(
        {
            ".fixtures": ("fixtures",),
            ".servers": ("servers",),
            ".servers.test_apache_servers": ("TestsFlextLdifApacheServers",),
            ".servers.test_ds389_servers": ("TestsFlextLdifDs389Servers",),
            ".servers.test_edge_cases": ("TestsFlextLdifEdgeCases",),
            ".servers.test_novell_servers": ("TestsFlextLdifNovellServers",),
            ".servers.test_oid_acl_assemble": ("TestsFlextLdifOidAclAssemble",),
            ".servers.test_oid_acl_convert": ("TestsFlextLdifOidAclConvert",),
            ".servers.test_oid_acl_convert_oud": ("TestsFlextLdifOidAclConvertOud",),
            ".servers.test_oid_acl_endtoend": ("TestsFlextLdifOidAclEndToEnd",),
            ".servers.test_oid_servers": ("TestsFlextLdifOidServers",),
            ".servers.test_relaxed_servers": ("TestsFlextLdifRelaxed",),
            ...
            ".services.test_api_server_registry": ("TestsFlextLdifApiServerRegistry",),
            ".services.test_detector_service": ("TestsFlextLdifDetectorService",),
            ".services.test_entries_service": ("TestsFlextLdifEntries",),
            ".services.test_filters_service": ("TestsFlextLdifFiltersService",),
            ".services.test_migration_pipeline": ("TestsFlextLdifMigrationPipeline",),
