...
class TestAbsoluteUltimatumZeroTolerance:
    ...
    def test_parser_service_force_all_missing_lines_absolute(self) -> None:
        ...
        FlextLDIFServices.RepositoryService(entries=[test_entry], config=config)
    ...
    def test_all_service_constructors_force_branches(self) -> None:
    ...
    def test_repository_service_force_all_methods_absolute(self) -> None:
