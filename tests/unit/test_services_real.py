...
class TestAnalyticsService:
    ...
    def test_analyze_dn_depth(self) -> None:
        ...
        entries = [
            ...
            FlextLdifModels.create_entry(
                {
                    "dn": "cn=REDACTED_LDAP_BIND_PASSWORD,ou=system,ou=config,dc=example,dc=com",
        ...
        )  # cn=REDACTED_LDAP_BIND_PASSWORD,ou=system,ou=config,dc=example,dc=com (5 components)
