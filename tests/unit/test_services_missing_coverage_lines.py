...
class TestServicesMissingCoverageLines:
    """Test cases for missing coverage lines in services.py."""

    def test_parser_validate_ldif_syntax_empty_lines_after_split(self) -> None:
        """Test parser validate_ldif_syntax with empty lines after split."""
        services = FlextLDIFServices()
        parser = services.parser

        # Test content that results in empty lines after split
        # This should trigger the "No lines found" condition
